=== Image Merchandise Store For Wordpress ===
Contributors: pixter, itayamar, gilade, ronshe
Plugin Name: Image Merchandise Store For Wordpress
Plugin URI: https://www.pixter-media.com
Author: Pixter.me
Author URI: https://www.pixter.me
Tags: image, picture, merchandise, free, photo prints, photo products, photo merchandise, monetization, woo, store, storefront, shopify, create store, shopify, make store, ecommerce,
...
This is a Merchandise Store plugin, which lets you instantly create a store out of any image you have on your site, no setup time or cost involved.

== Description ==
Visitors can shop for amazing photo products directly from images on your Wordpress site.

**Merchandise Store for Wordpress** is powered by **Pixter.me**, and turns your website images into **photo products** your can sell directly, with a simple smart integration of this plugin, and no long setup or cost.

Setup is easy, but we do offer support and reply as quick as we can.

[youtube https://www.youtube.com/watch?v=h9OPcGmyqxY]

Make money using this plugin, directly from your Wordpress website, with a *dedicated store* of photo prints for your site. With a slick and smart plugin installation, you can create your own online store and sell your images as photo products like a real online shop experience, offering. Take advantage of your Facebook, Instagram, Pinterest, twitter or flickr photos and images, to make great print products to sell to your fan base, school team, non-profit supporters, clubs or stations.

Easily offer print products such as Mugs, Tshirts, Framed Canvases, Phone Cases, Magnets, Cards and many more. These online products can be easily ordered from your site, and shipped anywhere worldwide with this simple plugin store. It’s powered by Pixter and is completely free, and helps you make money for your Wordpress site.

= Advantages =
* **Hassle Free** - Create a store in seconds.
* **Minimal Setup** - Simply activate, and register an account with Pixter and you are done.
* **Make money** - Support your cause - Your website gets a significant revenue share from every order of photo prints on a variety of products.
* **Tracking and Shipping** - An online tracking of the orders from your shop is available though Pixter.me. As well as support and round the clock care.
* **Works on popular WP image galleries** - we make sure to be compatible with leading gallery plugins.
* **Responsive to Mobile** - our buttons and store react to the users’ device and browser to offer the most responsive solution, just like your website.
...
Your Wordpress visitors can enjoy an engaging experience and tangible, beautiful products printed as photo prints, in an online store of your very own, without the hassle of opening and handling an online shop. It’s a great way to offer personalized gifts, custom products, and physical content to make money.

Upon activation, the Pixter.me store is ready to go. "Order printed"  buttons are visible on hovered images. Pixter.me can be configured to include or exclude specific pages and elements, visuals, colors and much more so you can configure you online store, and create a customized commerce solution of your own to sell photo prints.

Pixter.me's global printing service makes premium photo products and delivers high standards of service.Try us for free, and merchandise your cause, to offer your fans the best of your site!

= How it Works =
This plugin is powered by Pixter.me, a leading world brand in merchandise printing. It’s plugin creates button widgets on any graphic element, photo, image or picture you choose on your site. Users who click it see an overlay which presents them with product options, where they can choose to print it on a variety of products from the Pixter gallery and ship it worldwide through our integrated commerce solution.

It's that easy, it’s that free!

= Build a Store =
Create your very own ecommerce store and sell your site images with an online store for free, through a beautiful gallery, with a simple and slick interface button on every image. Let us be your full experience Ecommerce supply software. Bring your site's images as well as your instagram, Facebook, pinterest images to life through irresistible photo products you can sell online. Make money from a simple widget and help your community support your site. Once installed, the plugin can be configured within the Wordrpess admin, and includes advanced plugin features in a dedicated control panel for your account on Pixter.me.

This is a great monetization plugin for your site, if you want to support your cause with no ads or banners, and helps you monetise in a simple, and smart way.
...
Once activated you will need to register to see Pixter.me buttons on your site images. In order to earn money for your merchandise you must register in the plugin page
...
= Why connect to Merchandise by Pixter.me? =
Pixter.me lets you offer your users new value-added services while instantly creating new ways to monetize your site. With Pixter.me, your users can easily order photo products featuring your images or brand from within your websites and apps. That’s because Pixter.me automatically converts any image into amazing photo-products that can be shipped anywhere in the world. Your users click on a button to place their order and we take care of the rest - from populating and managing your “in-store” experience to helping you market it on your site to handing all the printing and shipping logistics. It’s what we do!
= Who is Pixter.me for? =
Pixter.me is for websites, apps and brands that are looking for creative new ways to extend their brand offerings to users and create exciting new monetization channels. We believe in enabling a win-win partnership that benefits both website and app owners and the users they serve. We also offer a special solution for Image-Galleries,  for Facebook pages and WordPress websites.




= How does Pixter.me work? =
Getting started with Pixter.me is easy. A simple one-line integration is all it takes to add a Pixter.me store to your website or app. Just include our SDK in your code and add an "Order Prints" button to your screen. Pixter.me offers a full “out of the box” solution that takes care of everything else from there, seamlessly and painlessly. No need to set up a payment account or provide customer support. Pixter.me takes care of it all from setting up your integrated on-site photo-products store with UI and payment to production, shipping and customer service. We also offer a “plug&play” instant solution for website with image Galleries where we scan the websites for images and locate “Order printed” buttons next to them. For Facebook pages as well as for WordPress websites we offer an “instant” connection with the click of a button. In other words, we do the work –you enjoy the revenue income.
= How much does it cost? =
As a website or app owner, integration with the Pixter.me API is absolutely free of charge. We believe our service brings value to you and the way we get paid is when you see success, based on revenue share.
= What does a Publisher account include? =
A Pixter.me Publisher account allows you to copy your integration line, test your integrated store and then go live and follow your product sales in real time. You can also access additional business and production information as well as download financial reports to track your store’s performance. While our “out of the box” offering means you can get started right away, it’s also possible to custom-tailor your store, to modify its appearance, select products, and set your own prices and margins.
